...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    if (!left.isEmpty && mostLeft.retweets > elem.retweets)
      if (!right.isEmpty && mostRight.retweets > mostLeft.retweets) mostRight
      else mostLeft
    else if (!right.isEmpty && mostRight.retweets > elem.retweets) mostRight
    else elem
  }
