...
// Example class using std::optional for an optional middle name
class Contact {
public:
    Contact(const string first, const optional<string> middle, const string last)
...
int main() {
    ...
    Contact contact1("John", "M.", "Doe");
    Contact contact2("Jane", nullopt, "Smith");

    contact1.Print(); // Output: John M. Doe
    contact2.Print(); // Output: Jane Smith
